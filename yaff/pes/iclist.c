...
void hessian_oop_distance(iclist_row_type* ic, dlist_row_type* deltas, double value, double grad, double* hessian, long ndelta) {
   ...
   double t10 = y1*z0;
   double t11 = -t10 + t9;
   double t12 = t11*t11 + t2*t2 + t6*t6;
   double t13 = 1.0/(sqrt(t12*t12*t12));
   double t14 = grad*s0*s1*s2*t13*t8;
   double t15 = -pow(y1, 2);
   double t16 = -pow(z1, 2);
   double t17 = -t4 + t5;
   double t18 = t11*x2 + t17*y2 + t2*z2;
   double t19 = grad*s0*s1*s2*t13*t18;
   double t20 = 1.0/(sqrt(t12*t12*t12*t12*t12));
   double t21 = grad*s0*s1*s2*t18*t20*t8;
   double t22 = y1*z2 - y2*z1;
   double t23 = t2*x1;
   double t24 = t11*z1;
   double t25 = t23 - t24;
   double t26 = grad*s0*s1*s2*t13*t25;
   double t27 = -x1*z2 + x2*z1;
   double t28 = grad*s0*s1*s2*t13*t18*x1;
   double t29 = 3*t23 - 3*t24;
   double t30 = t14*t27 + t21*t29 + t22*t26 + t28*y1;
   double t31 = t6*x1;
   double t32 = t11*y1;
   double t33 = t31 + t32;
   double t34 = grad*s0*s1*s2*t13*t33;
   double t35 = x1*y2 - x2*y1;
   double t36 = 3*t31 + 3*t32;
   double t37 = t14*t35 + t21*t36 + t22*t34 + t28*z1;
   double t38 = t2*y0;
   double t39 = t6*z0;
   double t40 = t38 + t39;
   double t41 = grad*s0*s1*s2*t13*t40;
   double t42 = -y0*z2 + y2*z0;
   double t43 = y0*y1;
   double t44 = z0*z1;
   double t45 = 3*t38 + 3*t39;
   double t46 = grad*s0*s1*s2*t18*t20*t45;
   double t47 = t14*t42 + t19*(t43 + t44) + t22*t41 + t46*t8;
   double t48 = grad*s0*s1*s2/sqrt(t12);
   double t49 = t48*z2;
   double t50 = t11*z0;
   double t51 = t2*x0;
   double t52 = t50 - t51;
   double t53 = grad*s0*s1*s2*t13*t52;
   double t54 = grad*s0*s1*s2*t13*(x0*z2 - x2*z0);
   double t55 = grad*s0*s1*s2*t18*t20*(3*t50 - 3*t51);
   double t56 = t19*(-2*t0 + t1) + t22*t53 + t49 + t54*t8 + t55*t8;
   double t57 = t48*y2;
   double t58 = grad*s0*s1*s2*t13*(-x0*y2 + x2*y0);
   double t59 = t6*x0;
   double t60 = t11*y0;
   double t61 = -t59 - t60;
   double t62 = grad*s0*s1*s2*t13*t61;
   double t63 = grad*s0*s1*s2*t18*t20*(-3*t59 - 3*t60);
   double t64 = t19*(-2*t4 + t5) + t22*t62 - t57 + t58*t8 + t63*t8;
   double t65 = t11*t14;
   double t66 = t48*z1;
   double t67 = grad*s0*s1*s2*t13*t17;
   double t68 = -t66 + t67*t8;
   double t69 = t48*y1;
   double t70 = grad*s0*s1*s2*t13*t2;
   double t71 = t69 + t70*t8;
   double t72 = -pow(x1, 2);
   double t73 = grad*s0*s1*s2*t18*t20*t25;
   double t74 = t19*y1*z1 + t26*t35 + t27*t34 + t36*t73;
   double t75 = t19*(t0 - 2*t1) + t25*t46 + t26*t42 + t27*t41 - t49;
   double t76 = x0*x1;
   double t77 = t19*(t44 + t76) + t25*t54 + t25*t55 + t27*t53;
   double t78 = t48*x2;
   double t79 = t19*(t10 - 2*t9) + t25*t58 + t25*t63 + t27*t62 + t78;
   double t80 = t11*t26 + t66;
   double t81 = t25*t67;
   double t82 = t48*x1;
   double t83 = t25*t70 - t82;
   double t84 = grad*s0*s1*s2*t18*t20*t33;
   double t85 = t19*(t4 - 2*t5) + t34*t42 + t35*t41 + t45*t84 + t57;
   double t86 = t19*(-2*t10 + t9) + t33*t54 + t33*t55 + t35*t53 - t78;
   double t87 = t19*(t43 + t76) + t33*t58 + t33*t63 + t35*t62;
   double t88 = t11*t34 - t69;
   double t89 = t33*t67 + t82;
   double t90 = t33*t70;
   double t91 = -pow(y0, 2);
   double t92 = -pow(z0, 2);
   double t93 = grad*s0*s1*s2*t13*t18*x0;
   double t94 = t40*t54 + t40*t55 + t42*t53 + t93*y0;
   double t95 = t40*t58 + t40*t63 + t42*t62 + t93*z0;
   double t96 = t11*t41;
   double t97 = t48*z0;
   double t98 = t40*t67 + t97;
   double t99 = t48*y0;
   double t100 = t40*t70 - t99;
   double t101 = -pow(x0, 2);
   double t102 = t19*y0*z0 + t52*t58 + t52*t63 + t54*t61;
   double t103 = t11*t53 - t97;
   double t104 = t52*t67;
   double t105 = t48*x0;
   double t106 = t105 + t52*t70;
   double t107 = t11*t62 + t99;
   double t108 = -t105 + t61*t67;
   double t109 = t61*t70;
   // Fill up Hessian
   hessian[(3*(*ic).i0+0)*ndelta + 3*(*ic).i0+0] +=  t14*(2*y1*z2 - 2*y2*z1) + t19*(t15 + t16) + t21*(-3*t3 - 3*t7);
   hessian[(3*(*ic).i0+0)*ndelta + 3*(*ic).i0+1] +=  t30;
   hessian[(3*(*ic).i0+0)*ndelta + 3*(*ic).i0+2] +=  t37;
   hessian[(3*(*ic).i0+1)*ndelta + 3*(*ic).i0+0] +=  t30;
   hessian[(3*(*ic).i0+1)*ndelta + 3*(*ic).i0+1] +=  t19*(t16 + t72) + t26*(-2*x1*z2 + 2*x2*z1) + t29*t73;
   hessian[(3*(*ic).i0+1)*ndelta + 3*(*ic).i0+2] +=  t74;
   hessian[(3*(*ic).i0+2)*ndelta + 3*(*ic).i0+0] +=  t37;
   hessian[(3*(*ic).i0+2)*ndelta + 3*(*ic).i0+1] +=  t74;
   hessian[(3*(*ic).i0+2)*ndelta + 3*(*ic).i0+2] +=  t19*(t15 + t72) + t34*(2*x1*y2 - 2*x2*y1) + t36*t84;
   hessian[(3*(*ic).i0+0)*ndelta + 3*(*ic).i1+0] +=  t47;
   hessian[(3*(*ic).i0+0)*ndelta + 3*(*ic).i1+1] +=  t56;
   hessian[(3*(*ic).i0+0)*ndelta + 3*(*ic).i1+2] +=  t64;
   hessian[(3*(*ic).i0+1)*ndelta + 3*(*ic).i1+0] +=  t75;
   hessian[(3*(*ic).i0+1)*ndelta + 3*(*ic).i1+1] +=  t77;
   hessian[(3*(*ic).i0+1)*ndelta + 3*(*ic).i1+2] +=  t79;
   hessian[(3*(*ic).i0+2)*ndelta + 3*(*ic).i1+0] +=  t85;
   hessian[(3*(*ic).i0+2)*ndelta + 3*(*ic).i1+1] +=  t86;
   hessian[(3*(*ic).i0+2)*ndelta + 3*(*ic).i1+2] +=  t87;
   hessian[(3*(*ic).i0+0)*ndelta + 3*(*ic).i2+0] +=  t65;
   hessian[(3*(*ic).i0+0)*ndelta + 3*(*ic).i2+1] +=  t68;
   hessian[(3*(*ic).i0+0)*ndelta + 3*(*ic).i2+2] +=  t71;
   hessian[(3*(*ic).i0+1)*ndelta + 3*(*ic).i2+0] +=  t80;
   hessian[(3*(*ic).i0+1)*ndelta + 3*(*ic).i2+1] +=  t81;
   hessian[(3*(*ic).i0+1)*ndelta + 3*(*ic).i2+2] +=  t83;
   hessian[(3*(*ic).i0+2)*ndelta + 3*(*ic).i2+0] +=  t88;
   hessian[(3*(*ic).i0+2)*ndelta + 3*(*ic).i2+1] +=  t89;
   hessian[(3*(*ic).i0+2)*ndelta + 3*(*ic).i2+2] +=  t90;
   hessian[(3*(*ic).i1+0)*ndelta + 3*(*ic).i0+0] +=  t47;
   hessian[(3*(*ic).i1+0)*ndelta + 3*(*ic).i0+1] +=  t75;
   hessian[(3*(*ic).i1+0)*ndelta + 3*(*ic).i0+2] +=  t85;
   hessian[(3*(*ic).i1+1)*ndelta + 3*(*ic).i0+0] +=  t56;
   hessian[(3*(*ic).i1+1)*ndelta + 3*(*ic).i0+1] +=  t77;
   hessian[(3*(*ic).i1+1)*ndelta + 3*(*ic).i0+2] +=  t86;
   hessian[(3*(*ic).i1+2)*ndelta + 3*(*ic).i0+0] +=  t64;
   hessian[(3*(*ic).i1+2)*ndelta + 3*(*ic).i0+1] +=  t79;
   hessian[(3*(*ic).i1+2)*ndelta + 3*(*ic).i0+2] +=  t87;
   hessian[(3*(*ic).i1+0)*ndelta + 3*(*ic).i1+0] +=  t19*(t91 + t92) + t40*t46 + t41*(-2*y0*z2 + 2*y2*z0);
   hessian[(3*(*ic).i1+0)*ndelta + 3*(*ic).i1+1] +=  t94;
   hessian[(3*(*ic).i1+0)*ndelta + 3*(*ic).i1+2] +=  t95;
   hessian[(3*(*ic).i1+1)*ndelta + 3*(*ic).i1+0] +=  t94;
   hessian[(3*(*ic).i1+1)*ndelta + 3*(*ic).i1+1] +=  t19*(t101 + t92) + t52*t55 + t54*(2*t11*z0 - 2*t2*x0);
   hessian[(3*(*ic).i1+1)*ndelta + 3*(*ic).i1+2] +=  t102;
   hessian[(3*(*ic).i1+2)*ndelta + 3*(*ic).i1+0] +=  t95;
   hessian[(3*(*ic).i1+2)*ndelta + 3*(*ic).i1+1] +=  t102;
   hessian[(3*(*ic).i1+2)*ndelta + 3*(*ic).i1+2] +=  t19*(t101 + t91) + t58*(-2*t11*y0 - 2*t6*x0) + t61*t63;
   hessian[(3*(*ic).i1+0)*ndelta + 3*(*ic).i2+0] +=  t96;
   hessian[(3*(*ic).i1+0)*ndelta + 3*(*ic).i2+1] +=  t98;
   hessian[(3*(*ic).i1+0)*ndelta + 3*(*ic).i2+2] +=  t100;
   hessian[(3*(*ic).i1+1)*ndelta + 3*(*ic).i2+0] +=  t103;
   hessian[(3*(*ic).i1+1)*ndelta + 3*(*ic).i2+1] +=  t104;
   hessian[(3*(*ic).i1+1)*ndelta + 3*(*ic).i2+2] +=  t106;
   hessian[(3*(*ic).i1+2)*ndelta + 3*(*ic).i2+0] +=  t107;
   hessian[(3*(*ic).i1+2)*ndelta + 3*(*ic).i2+1] +=  t108;
   hessian[(3*(*ic).i1+2)*ndelta + 3*(*ic).i2+2] +=  t109;
   hessian[(3*(*ic).i2+0)*ndelta + 3*(*ic).i0+0] +=  t65;
   hessian[(3*(*ic).i2+0)*ndelta + 3*(*ic).i0+1] +=  t80;
   hessian[(3*(*ic).i2+0)*ndelta + 3*(*ic).i0+2] +=  t88;
   hessian[(3*(*ic).i2+1)*ndelta + 3*(*ic).i0+0] +=  t68;
   hessian[(3*(*ic).i2+1)*ndelta + 3*(*ic).i0+1] +=  t81;
   hessian[(3*(*ic).i2+1)*ndelta + 3*(*ic).i0+2] +=  t89;
   hessian[(3*(*ic).i2+2)*ndelta + 3*(*ic).i0+0] +=  t71;
   hessian[(3*(*ic).i2+2)*ndelta + 3*(*ic).i0+1] +=  t83;
   hessian[(3*(*ic).i2+2)*ndelta + 3*(*ic).i0+2] +=  t90;
   hessian[(3*(*ic).i2+0)*ndelta + 3*(*ic).i1+0] +=  t96;
   hessian[(3*(*ic).i2+0)*ndelta + 3*(*ic).i1+1] +=  t103;
   hessian[(3*(*ic).i2+0)*ndelta + 3*(*ic).i1+2] +=  t107;
   hessian[(3*(*ic).i2+1)*ndelta + 3*(*ic).i1+0] +=  t98;
   hessian[(3*(*ic).i2+1)*ndelta + 3*(*ic).i1+1] +=  t104;
   hessian[(3*(*ic).i2+1)*ndelta + 3*(*ic).i1+2] +=  t108;
   hessian[(3*(*ic).i2+2)*ndelta + 3*(*ic).i1+0] +=  t100;
   hessian[(3*(*ic).i2+2)*ndelta + 3*(*ic).i1+1] +=  t106;
   hessian[(3*(*ic).i2+2)*ndelta + 3*(*ic).i1+2] +=  t109;
