    ...
    ext_modules=[
        Extension("yaff.pes.ext",
            sources=['yaff/pes/ext.pyx', 'yaff/pes/nlist.c',
                     ...
                     'yaff/pes/truncation.c', 'yaff/pes/switchon.c',
                     'yaff/pes/slater.c'],
            depends=['yaff/pes/nlist.h', 'yaff/pes/nlist.pxd',
                     ...
                     'yaff/pes/switchon.h', 'yaff/pes/switchon.pxd',
        ...
        Extension("yaff.pes.splines",
            sources=['yaff/pes/splines.pyx','yaff/pes/splinepot.cpp'],
            depends=['yaff/pes/splinepot.h','yaff/pes/splines.pxd'],
            language="c++",
            extra_compile_args=["-Wall","-O3","-std=c++0x","-fPIC","-Wno-sign-compare","-fopenmp"],
            extra_link_args=["-fopenmp"],
            include_dirs=[np.get_include()],
