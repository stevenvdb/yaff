...
setup(
    ...
    ext_modules=[
        ...
        Extension("yaff.pes.liblammps",
            sources=['yaff/pes/liblammps.pyx', 'yaff/pes/mylammps.cpp',],
            depends=['yaff/pes/mylammps.h', 'yaff/pes/mylammps.pxd',],
            language="c++",
            include_dirs=[np.get_include()],
            extra_link_args = ["-llammps_mpi","-lpthread"],
            extra_compile_args = ["-DMPICH_IGNORE_CXX_SEEK"],
            ),
    ],
    classifiers=[
